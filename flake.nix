{
  description = "Development environment with Node.js 24.21.0";
  ...
  flake-utils.lib.eachDefaultSystem (system:
    let
      ...
      # Custom Node.js 24.21.0 derivation
      nodeInfo = {
        "x86_64-linux" = {
        ...
        "x86_64-darwin" = {
          url = "https://nodejs.org/dist/v24.21.0/node-v24.21.0-darwin-x64.tar.xz";
      ...
      nodejs-24_21_0 = pkgs.stdenv.mkDerivation rec {
        pname = "nodejs";
        version = "24.21.0";
