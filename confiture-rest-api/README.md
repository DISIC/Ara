...
Pour cela, définir des _DTO_ (data transfer object) pour la requête et pour la réponse (voir le dossier `src/audits/dto` pour des exemples) et les associer à la route via :
