...
describe("Report", () => {
  ...
  it("User can filter errors", () => {
    cy.createTestAudit({ isComplete: true }).then(({ reportId }) => {
      cy.visit(`http://localhost:3000/rapport/${reportId}`);
      cy.contains("button", "Détails des non-conformités").click();
      cy.contains("315 Non-conformités détaillées");
      cy.get(
      ...
      cy.contains("45 Non-conformités détaillées");
      cy.get(
        "#tabpanel-details-des-non-conformites-panel .criterium-title",
      ).then((els) => {
      ...
      cy.contains("234 Non-conformités détaillées");
      cy.get(
        "#tabpanel-details-des-non-conformites-panel .criterium-title",
      ).then((els) => {
      ...
      cy.contains("153 Non-conformités détaillées");
      cy.get(
        "#tabpanel-details-des-non-conformites-panel .criterium-title",
      ).then((els) => {
      ...
      cy.contains("72 Non-conformités détaillées");
      cy.get(
        "#tabpanel-details-des-non-conformites-panel .criterium-title",
      ).then((els) => {
      ...
      cy.contains("0 Non-conformités détaillées");
      cy.get(
        "#tabpanel-details-des-non-conformites-panel .criterium-title",
      ).should("not.exist");
