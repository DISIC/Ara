  ...
  <template v-if="report.data">
    ...
    >
      ...
      <template #accordion>
        ...
        aspernatur commodi cupiditate a aut placeat consequatur sed
        exercitationem praesentium, corporis dolorem quas fugiat consequuntur
        quod illo eaque mollitia iusto alias!
      </template>
    </ResultDetailsCard>
