...
import { ARRAY_LENGTH, REQUIRED } from "../../../composables/validation";
...
<template>
  <FieldValidation
    ...
    :validation="[ARRAY_LENGTH(1, 'Information obligatoire. Indiquez les environnements de test.')]"
    :value="modelValue"
  >
    <div
      :ref="focusRef"
    ...
    >
      ...
      <p v-if="error" :id="errorId" class="fr-error-text">
        {{ error }}
      </p>
    </div>
  </FieldValidation>
