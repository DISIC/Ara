...
Dans ce cas, pour continuer votre visite vous pouvez consulter notre page d’accueil ou nous contacter par e-mail à l'adresse suivante : **rgaa@design.numerique.gouv.fr**.
    `,
    408: `
Vous pouvez :
...
Si vous avez besoin d’une aide, merci de nous contacter par e-mail à l'adresse suivante : **rgaa@design.numerique.gouv.fr**.
    `,
    500: `
...
Si vous avez besoin d’une aide, nous contacter par e-mail à l'adresse suivante : **rgaa@design.numerique.gouv.fr**.
    `,
  }[statusCode] ??
