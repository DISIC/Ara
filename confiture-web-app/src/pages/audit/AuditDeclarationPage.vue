...
<template>
  ...
  >
    ...
    <p>
      Les contenus dérogés doivent être discutés entre l’auditeur et le responsable du site audité. C’est le responsable du site qui accepte de prendre le risque juridique de mentionner ces contenus.
    </p>
